...
# pygame.mixer.music.load('lab7/task2/music/2024.mp3')
...
background = pygame.image.load("lab8/task1/PygameTutorial_3_0/AnimatedStreet.png")
bg_img = pygame.image.load("lab8/task1/PygameTutorial_3_0/cartigoofy.jpg")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self, exclude):
        super().__init__() 
        self.image = pygame.image.load("lab8/task1/PygameTutorial_3_0/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, exclude):
        ...
        self.image = pygame.transform.scale(
            pygame.image.load("lab8/task1/PygameTutorial_3_0/transparent_coin.png"), (60, 60)
        )
        self.rect = self.image.get_rect()
        self.rect.center = get_random_position(exclude)
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab8/task1/PygameTutorial_3_0/Player.png")
        self.rect = self.image.get_rect()
...
coins_since_last_speed_increase = 0  # Track the number of coins collected since the last speed increase
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('lab8/task1/PygameTutorial_3_0/crash.wav').play()
          time.sleep(1)
    ...
    if pygame.sprite.spritecollideany(P1, coines):
        ...
        coins_since_last_speed_increase += 1  # Increment the count of coins collected since the last speed increase

        # Increase speed every 5 coins
        if coins_since_last_speed_increase >= 5:
            SPEED += 2  # Increase speed by 2 units
            coins_since_last_speed_increase = 0  # Reset the count for the next speed increase
